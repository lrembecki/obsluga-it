...
[Migration("20251230123917_Settings-EmailTemplate-202512301339")]
partial class SettingsEmailTemplate202512301339
{
    /// <inheritdoc />
...
#pragma warning disable 612, 618
        ...
        modelBuilder.Entity("lrembecki.core.settings.Entities.EmailTemplateEntity", b =>
            {
                b.Property<Guid>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("uniqueidentifier");
        ...
        modelBuilder.Entity("lrembecki.core.settings.Entities.EmailTemplateFieldEntity", b =>
            {
                b.Property<Guid>("EmailTemplateId")
                    .HasColumnType("uniqueidentifier");
        ...
        modelBuilder.Entity("lrembecki.core.settings.Entities.NotificationEntity", b =>
            {
                b.Property<Guid>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("uniqueidentifier");
        ...
        modelBuilder.Entity("EmailTemplate_Contacts_Bcc", b =>
            {
                b.HasOne("lrembecki.core.settings.Entities.ContactEntity", null)
                    .WithMany()
                    .HasForeignKey("ContactId")
                    .OnDelete(DeleteBehavior.Restrict)
                    .IsRequired();

                b.HasOne("lrembecki.core.settings.Entities.EmailTemplateEntity", null)
                    .WithMany()
        ...
        modelBuilder.Entity("lrembecki.core.forms.FormDefinitions.FormDefinitionEntity", b =>
            {
                b.HasOne("lrembecki.core.settings.Entities.NotificationEntity", "Notification")
                    .WithMany()
        ...
        modelBuilder.Entity("lrembecki.core.settings.Entities.EmailTemplateEntity", b =>
            {
                ...
                b.HasOne("lrembecki.core.storage.Entities.StorageEntity", "TemplateHtml")
                    .WithOne()
                    .HasForeignKey("lrembecki.core.settings.Entities.EmailTemplateEntity", "TemplateHtmlId")
                    .OnDelete(DeleteBehavior.Restrict)
                    .IsRequired();
        ...
        modelBuilder.Entity("lrembecki.core.settings.Entities.NotificationEntity", b =>
            {
                ...
                b.OwnsOne("lrembecki.core.settings.Entities.EmailNotificationEntity", "Email", b1 =>
                    {
                        ...
                        b1.HasOne("lrembecki.core.settings.Entities.EmailEntity", "Email")
                            .WithMany()
                            .HasForeignKey("EmailId")
                            .OnDelete(DeleteBehavior.Restrict)
                            .IsRequired();

                        b1.HasOne("lrembecki.core.settings.Entities.EmailTemplateEntity", "EmailTemplate")
                            .WithMany()
                            .HasForeignKey("EmailTemplateId")
                            .OnDelete(DeleteBehavior.Restrict)
                            .IsRequired();
