...
[Migration("20251105203949_Trotamundos-TripHighlights-V1")]
partial class TrotamundosTripHighlightsV1
{
    /// <inheritdoc />
...
#pragma warning disable 612, 618
        ...
        modelBuilder.Entity("TrotamundosTripHighlightTrip", b =>
            {
                ...
                b.HasKey("TripHighlightId", "TripId");

                b.HasIndex("TripId");

                b.ToTable("TrotamundosTripHighlightTrip", "app");
            });
        ...
        modelBuilder.Entity("TrotamundosTripHighlightTrip", b =>
            {
                b.HasOne("lrembecki.core.trotamundos.Entitites.TripHighlightEntity", null)
                    .WithMany()
        ...
        modelBuilder.Entity("lrembecki.core.trotamundos.Entitites.TripHighlightEntity", b =>
            {
                b.HasOne("lrembecki.core.trotamundos.Entitites.HighlightEntity", "Highlight")
                    .WithMany()
