...
import { AUTH_RUNTIME_CONFIG } from '../../../../libs/core/auth/src/lib/models/auth-runtime-config.model';

const isIE =
  globalThis.navigator.userAgent.includes('MSIE ') ||
...
export function provideMsal(): (Provider | EnvironmentProviders)[] {
  return [
    ...
    MsalGuard,
    {
      ...
      useValue: {
        authenticateEndpoint: environment.apiUrl + '/authenticate',
        msalScopes: environment.msal.scopes.default,
      },
    },
  ];
}
